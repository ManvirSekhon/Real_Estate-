...
const getFromAddress = (title = "Real Estate Marketplace") => {
    return `"${title}" <${process.env.EMAIL_USER}>`;
};
...
const sendWelcomeEmail = async (email, name) => {
    try {
        ...
        const mailOptions = {
            from: getFromAddress("Real Estate App"),
            to: email,
...
const sendLoginAlert = async (email, name) => {
    try {
        ...
        const mailOptions = {
            from: getFromAddress("Real Estate Security"),
            to: email,
            ...
            html: `
                ...
                <p style="color: red;"><strong>If you did not log in, please reset your password immediately.</strong></p>
                <br>
                <p>Stay secure,</p>
...
const sendVerificationEmail = async (email, name, verificationLink) => {
    try {
        ...
        const mailOptions = {
            from: getFromAddress("Real Estate Marketplace"),
            to: email,
